import type { JsonSchema, LLMRequest, ProviderMetadata } from "@axiom-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@axiom-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @axiom-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
