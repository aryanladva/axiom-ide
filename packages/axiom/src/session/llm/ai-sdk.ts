import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@axiom-ai/llm"
...
// Move this extraction into @axiom-ai/llm when Copilot is handled by the native runtime.
