...
- Effect plugins import `@axiom-ai/plugin/v2/effect`, not `@axiom-ai/core`.
- Public domain values use generated `@axiom-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@axiom-ai/plugin/v2/effect`.
