...
import { Hash } from "@axiom-ai/core/util/hash"
...
import { optional } from "@axiom-ai/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@axiom-ai/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
