...
import { llmClient } from "@axiom-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@axiom-ai/llm"
import { LLMClient } from "@axiom-ai/llm/route"
import type { LLMClientService } from "@axiom-ai/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @axiom-ai/llm. It
