export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af AXIOM",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af AXIOM er blevet downloadet. Vil du installere den og genstarte?",
