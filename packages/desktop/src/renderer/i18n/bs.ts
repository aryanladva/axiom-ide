export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju AXIOM-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} AXIOM-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
