export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av AXIOM",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av AXIOM har laddats ned. Vill du installera den och starta om programmet?",
