export const dict = {
  ...
  "desktop.updater.none.message": "AXIOM'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "AXIOM'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
