export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av AXIOM",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av AXIOM er lastet ned. Vil du installere den og starte på nytt?",
