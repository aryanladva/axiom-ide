export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di AXIOM",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di AXIOM è stata scaricata. Vuoi installarla e riavviare l'app?",
