export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de AXIOM",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de AXIOM. ¿Quieres instalarla y reiniciar?",
