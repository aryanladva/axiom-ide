export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru AXIOM",
  ...
  "desktop.updater.downloaded.prompt":
    "AXIOM versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
