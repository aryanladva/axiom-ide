export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van AXIOM",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van AXIOM is gedownload. Wil je deze installeren en AXIOM opnieuw starten?",
