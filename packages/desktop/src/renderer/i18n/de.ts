export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von AXIOM",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von AXIOM wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
