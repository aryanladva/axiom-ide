import { OpenCode } from "@axiom-ai/client/effect"
...
import { createEmbeddedRoutes } from "@axiom-ai/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@axiom-ai/sdk-next/OpenCode") {}
