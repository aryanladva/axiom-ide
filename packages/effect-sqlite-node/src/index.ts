...
export const TypeId: TypeId = "~@axiom-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@axiom-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@axiom-ai/effect-sqlite-node/NodeSqliteClient")
