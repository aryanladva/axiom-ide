...
> current private `@axiom-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@axiom-ai/ai`
...
import { LLM } from "@axiom-ai/ai"
import { OpenAI } from "@axiom-ai/ai/providers/openai"
...
```ts
import { Message } from "@axiom-ai/ai"
...
import { LLM, Tool } from "@axiom-ai/ai"
...
```ts
import { LLM } from "@axiom-ai/ai/promise"
import { OpenAI } from "@axiom-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@axiom-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@axiom-ai/ai/provider"
...
@axiom-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@axiom-ai/ai/providers/openai
@axiom-ai/ai/providers/anthropic
@axiom-ai/ai/providers/google
...
```
