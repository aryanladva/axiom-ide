...
import defaultSoundPath from "@axiom-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@axiom-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@axiom-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@axiom-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@axiom-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@axiom-ai/ui/audio/yup-01.mp3" with { type: "file" }
