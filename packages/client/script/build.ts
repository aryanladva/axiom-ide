...
import { compile, emitEffectImported, emitPromise, write } from "@axiom-ai/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@axiom-ai/protocol/groups/event"',
            },
          },
        }),
