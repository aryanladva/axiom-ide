...
export function env(key: string): string | undefined {
  const altKey = key.startsWith("OPENCODE_") ? key.replace("OPENCODE_", "AXIOM_") : key.startsWith("AXIOM_") ? key.replace("AXIOM_", "OPENCODE_") : key
...
export const Flag = {
  ...
  AXIOM_SERVER_PASSWORD: env("AXIOM_SERVER_PASSWORD"),
  AXIOM_SERVER_USERNAME: env("AXIOM_SERVER_USERNAME"),
  ...
  // Experimental
  OPENCODE_EXPERIMENTAL_FILEWATCHER: Config.boolean("AXIOM_EXPERIMENTAL_FILEWATCHER").pipe(
    Config.orElse(() => Config.boolean("OPENCODE_EXPERIMENTAL_FILEWATCHER")),
    Config.withDefault(false),
  ),
  OPENCODE_EXPERIMENTAL_DISABLE_FILEWATCHER: Config.boolean("AXIOM_EXPERIMENTAL_DISABLE_FILEWATCHER").pipe(
