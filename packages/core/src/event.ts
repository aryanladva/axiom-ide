...
import type { Data, Definition, Payload } from "@axiom-ai/schema/event"
...
import { Durable } from "@axiom-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@axiom-ai/schema/event").ID
export type { Data, Definition, Payload } from "@axiom-ai/schema/event"
