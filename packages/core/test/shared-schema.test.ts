...
import { AgentV2 } from "@axiom-ai/core/agent"
import { ModelV2 } from "@axiom-ai/core/model"
import { SessionV2 } from "@axiom-ai/core/session"
import { Agent } from "@axiom-ai/schema/agent"
import { Location } from "@axiom-ai/schema/location"
import { Model } from "@axiom-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@axiom-ai/schema/prompt"
import { Provider } from "@axiom-ai/schema/provider"
import { Project } from "@axiom-ai/schema/project"
import { ProjectDirectories } from "@axiom-ai/schema/project-directories"
import { PermissionV1 } from "@axiom-ai/schema/permission-v1"
import { Session } from "@axiom-ai/schema/session"
import { SessionInput } from "@axiom-ai/schema/session-input"
import { SessionMessage } from "@axiom-ai/schema/session-message"
import { Workspace } from "@axiom-ai/schema/workspace"
import { Command } from "@axiom-ai/schema/command"
import { Connection } from "@axiom-ai/schema/connection"
import { Credential } from "@axiom-ai/schema/credential"
import { FileSystem } from "@axiom-ai/schema/filesystem"
import { Integration } from "@axiom-ai/schema/integration"
import { LLM } from "@axiom-ai/schema/llm"
import { Permission } from "@axiom-ai/schema/permission"
import { Plugin } from "@axiom-ai/schema/plugin"
import { Pty } from "@axiom-ai/schema/pty"
import { Reference } from "@axiom-ai/schema/reference"
import { SessionTodo } from "@axiom-ai/schema/session-todo"
import { Skill } from "@axiom-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@axiom-ai/schema/schema"
import { ProviderV2 } from "@axiom-ai/core/provider"
import { PluginV2 } from "@axiom-ai/core/plugin"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@axiom-ai/core/command"),
    import("@axiom-ai/core/integration/connection"),
    import("@axiom-ai/core/credential"),
    import("@axiom-ai/core/filesystem"),
    import("@axiom-ai/core/integration"),
    import("@axiom-ai/core/location"),
    import("@axiom-ai/llm"),
    import("@axiom-ai/core/permission"),
    import("@axiom-ai/core/v1/permission"),
    import("@axiom-ai/core/project/copy"),
    import("@axiom-ai/core/pty"),
    import("@axiom-ai/core/project/schema"),
    import("@axiom-ai/core/reference"),
    import("@axiom-ai/core/session/input"),
    import("@axiom-ai/core/session/message"),
    import("@axiom-ai/core/session/todo"),
    import("@axiom-ai/core/session/prompt"),
    import("@axiom-ai/core/skill"),
    import("@axiom-ai/core/v2-schema"),
    import("@axiom-ai/core/schema"),
    import("@axiom-ai/core/workspace"),
  ])
