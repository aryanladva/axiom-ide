...
beforeAll(async () => {
  ...
  mock.module("@axiom-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@axiom-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@axiom-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@axiom-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
