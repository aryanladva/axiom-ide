...
export function useTitlebarRightMount() {
  ...
  const sync = () => setMount(document.getElementById("axiom-titlebar-right"))
  onMount(sync)
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="axiom-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                  </div>
                </div>
                <ChannelIndicator debugTools={props.debugTools} />
              </div>
            ...
            <div
              ...
              data-tauri-drag-region
            >
              <div id="axiom-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="axiom-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
