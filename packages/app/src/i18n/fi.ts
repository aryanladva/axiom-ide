export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "AXIOMn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja AXIOMssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja AXIOMssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja AXIOMssa.",
  ...
  "dialog.server.description": "Vaihda AXIOM-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan AXIOMa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan AXIOMa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään AXIOMa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään AXIOMa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä AXIOM jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna AXIOM jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOMa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin AXIOM voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "AXIOM ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten AXIOM uudelleen.",
  ...
  "toast.update.description": "AXIOMn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä AXIOM-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että AXIOM ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita AXIOM-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda AXIOMn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä AXIOM näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö AXIOM järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta AXIOMn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun AXIOM käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät AXIOMn uusinta versiota.",
  ...
  "desktop.menu.documentation": "AXIOM-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "AXIOM-valikko",
  ...
  "desktop.recovery.loadFailed": "AXIOMn lataaminen epäonnistui",
  "desktop.recovery.terminated": "AXIOM-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "AXIOM ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "AXIOMn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOMa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AXIOMn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "AXIOM Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
