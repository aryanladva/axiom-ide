export const dict = {
  ...
  "desktop.recovery.loadFailed": "AXIOM se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor AXIOM-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "AXIOM ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija AXIOM-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje AXIOM-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u AXIOM-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u AXIOM-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u AXIOM-u.",
  ...
  "dialog.server.description": "Promijeni na koji se AXIOM server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera AXIOM u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje AXIOM u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj AXIOM u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj AXIOM u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi AXIOM mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "AXIOM nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori AXIOM.",
  ...
  "help.tabs.introduction": "AXIOM Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija AXIOM-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku AXIOM timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: AXIOM još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni AXIOM server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u AXIOM-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako AXIOM izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li AXIOM prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu AXIOM-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se AXIOM pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju AXIOM-a.",
