export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل AXIOM",
  "desktop.recovery.terminated": "توقفت نافذة AXIOM بشكل غير متوقع",
  "desktop.recovery.unresponsive": "AXIOM لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت AXIOM",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث AXIOM، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من AXIOM",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في AXIOM.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في AXIOM.",
  ...
  "dialog.server.description": "تبديل خادم AXIOM الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من AXIOM في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث AXIOM في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث AXIOM في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت AXIOM في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن AXIOM من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على AXIOM التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح AXIOM.",
  ...
  "help.tabs.introduction": "أصبح AXIOM Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من AXIOM ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق AXIOM",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن AXIOM لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن AXIOM نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم AXIOM داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ AXIOM",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور AXIOM على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان AXIOM يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة AXIOM.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل AXIOM",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من AXIOM.",
