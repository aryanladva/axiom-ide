export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'AXIOM",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'AXIOM",
  "desktop.recovery.terminated": "La fenêtre AXIOM s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "AXIOM ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'AXIOM",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'AXIOM est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans AXIOM.",
  ...
  "provider.connect.opencodeZen.line1":
    "AXIOM Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans AXIOM.",
  ...
  "dialog.server.description": "Changez le serveur AXIOM auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'AXIOM dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'AXIOM dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour AXIOM dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez AXIOM dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'AXIOM puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "AXIOM n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez AXIOM.",
  ...
  "help.tabs.introduction": "AXIOM Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'AXIOM ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe AXIOM",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'AXIOM ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "AXIOM inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur AXIOM dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour AXIOM",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'AXIOM sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si AXIOM suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'AXIOM.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'AXIOM",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'AXIOM.",
