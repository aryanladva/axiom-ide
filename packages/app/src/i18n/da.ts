export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i AXIOM.",
  ...
  "provider.connect.opencodeZen.line1":
    "AXIOM Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i AXIOM.",
  ...
  "dialog.server.description": "Skift hvilken AXIOM-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker AXIOM i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer AXIOM i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater AXIOM i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer AXIOM i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før AXIOM kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "AXIOM kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter AXIOM igen.",
  ...
  "toast.update.description": "En ny version af AXIOM ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til AXIOM-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, AXIOM understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør AXIOM-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for AXIOM",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan AXIOM ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om AXIOM skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas AXIOMs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når AXIOM starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af AXIOM.",
  ...
  "desktop.recovery.loadFailed": "AXIOM kunne ikke indlæses",
  "desktop.recovery.terminated": "AXIOM-vinduet blev uventet afsluttet",
  "desktop.recovery.unresponsive": "AXIOM svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af AXIOM mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af AXIOM er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "AXIOM Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
