...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "AXIOM failed to load",
  "desktop.recovery.terminated": "AXIOM window terminated unexpectedly",
  "desktop.recovery.unresponsive": "AXIOM is not responding",
  ...
  "desktop.wsl.error.installOpencode": "AXIOM installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AXIOM update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
