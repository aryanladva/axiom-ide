...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in AXIOM zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "AXIOM Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in AXIOM zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in AXIOM zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den AXIOM-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "AXIOM",
  ...
  "wsl.onboarding.checkingOpencode": "AXIOM wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "AXIOM in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "AXIOM wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "AXIOM in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie AXIOM in {{distro}}.",
  "wsl.onboarding.updateOpencode": "AXIOM aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "AXIOM ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "AXIOM ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie AXIOM in {{distro}}.",
  "wsl.onboarding.installOpencode": "AXIOM installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor AXIOM einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "AXIOM konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann AXIOM erneut.",
  ...
  "toast.update.description": "Eine neue Version von AXIOM ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem AXIOM-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: AXIOM unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "AXIOM mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "AXIOM enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "AXIOM Desktop",
  ...
  "settings.desktop.wsl.description": "AXIOM-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für AXIOM ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie AXIOM auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob AXIOM dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von AXIOM anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von AXIOM automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "AXIOM ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von AXIOM wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "AXIOM konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das AXIOM-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "AXIOM reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "AXIOM-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das AXIOM-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "AXIOM Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
