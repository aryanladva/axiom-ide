...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "AXIOM kunne ikke lastes inn",
  "desktop.recovery.terminated": "AXIOM-vinduet ble uventet avsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av AXIOM mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av AXIOM er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i AXIOM.",
  ...
  "provider.connect.opencodeZen.line1":
    "AXIOM Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i AXIOM.",
  ...
  "dialog.server.description": "Bytt hvilken AXIOM-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av AXIOM ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til AXIOM-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at AXIOM ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør AXIOM-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for AXIOM",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan AXIOM ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om AXIOM skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i AXIOM.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når AXIOM starter",
  ...
  "settings.updates.toast.latest.title": "AXIOM er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av AXIOM.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker AXIOM i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer AXIOM i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater AXIOM i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før AXIOM kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "AXIOM kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter AXIOM på nytt.",
  ...
  "help.tabs.introduction": "AXIOM Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
