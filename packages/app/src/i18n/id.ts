export const dict = {
  ...
  "desktop.recovery.loadFailed": "AXIOM gagal dimuat",
  "desktop.recovery.terminated": "Jendela AXIOM berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "AXIOM tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi AXIOM gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan AXIOM selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di AXIOM.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di AXIOM.",
  ...
  "dialog.server.description": "Ganti server AXIOM mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa AXIOM di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui AXIOM di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui AXIOM di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM siap.",
  "wsl.onboarding.installOpencodeIn": "Instal AXIOM di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum AXIOM dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "AXIOM tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali AXIOM.",
  ...
  "help.tabs.introduction": "AXIOM Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru AXIOM ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim AXIOM",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: AXIOM belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server AXIOM di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk AXIOM",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan AXIOM di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah AXIOM mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema AXIOM.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat AXIOM diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru AXIOM.",
