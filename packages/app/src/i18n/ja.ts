export const dict = {
  ...
  "desktop.recovery.loadFailed": "AXIOMを読み込めませんでした",
  "desktop.recovery.terminated": "AXIOMのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "AXIOMが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "AXIOMのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはAXIOMがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "AXIOMのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "AXIOMが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、AXIOMで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "AXIOM Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAXIOMで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、AXIOMで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するAXIOMサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "AXIOMを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のAXIOMを確認中...",
  "wsl.onboarding.updatingOpencode": "AXIOMを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のAXIOMを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のAXIOMを更新してください。",
  "wsl.onboarding.updateOpencode": "AXIOMを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のAXIOMの準備ができました。",
  "wsl.onboarding.opencodeReady": "AXIOMの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にAXIOMをインストールしてください。",
  "wsl.onboarding.installOpencode": "AXIOMをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOMがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AXIOMでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、AXIOMをもう一度開いてください。",
  ...
  "help.tabs.introduction": "AXIOM Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AXIOMの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをAXIOMチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: AXIOMはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "AXIOMには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でAXIOMサーバーを実行します。",
  ...
  "settings.general.row.language.description": "AXIOMの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのAXIOMの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "AXIOMがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "AXIOMのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "AXIOM の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "AXIOM は最新バージョンです。",
