export const dict = {
  ...
  "desktop.menu.documentation": "AXIOM-documentatie",
  ...
  "desktop.recovery.loadFailed": "AXIOM kan niet worden geladen",
  "desktop.recovery.terminated": "Het AXIOM-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "AXIOM reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van AXIOM is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De AXIOM-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in AXIOM te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "AXIOM Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in AXIOM te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in AXIOM te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke AXIOM-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "AXIOM controleren...",
  "wsl.onboarding.checkingOpencodeIn": "AXIOM controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "AXIOM bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "AXIOM bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk AXIOM bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "AXIOM bijwerken",
  "wsl.onboarding.opencodeReadyIn": "AXIOM is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer AXIOM in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat AXIOM een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "AXIOM kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens AXIOM opnieuw.",
  ...
  "help.tabs.introduction": "AXIOM Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van AXIOM ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het AXIOM-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: AXIOM ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de AXIOM-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor AXIOM",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe AXIOM eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of AXIOM het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van AXIOM aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer AXIOM wordt gestart",
  ...
  "settings.updates.toast.latest.title": "AXIOM is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van AXIOM.",
