export const dict = {
  ...
  "desktop.recovery.loadFailed": "AXIOM kunde inte läsas in",
  "desktop.recovery.terminated": "AXIOM-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "AXIOM svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av AXIOM misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AXIOM-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i AXIOM.",
  ...
  "provider.connect.opencodeZen.line1":
    "AXIOM Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i AXIOM.",
  ...
  "dialog.server.description": "Växla vilken AXIOM-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar AXIOM i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar AXIOM i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera AXIOM i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera AXIOM i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan AXIOM kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "AXIOM kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan AXIOM igen.",
  ...
  "help.tabs.introduction": "AXIOM Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av AXIOM ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till AXIOM-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, AXIOM stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör AXIOM-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för AXIOM",
  ...
  "settings.general.row.appearance.description": "Anpassa hur AXIOM ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om AXIOM följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa AXIOMs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när AXIOM startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av AXIOM.",
