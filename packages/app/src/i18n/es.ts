export const dict = {
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar AXIOM",
  "desktop.recovery.terminated": "La ventana de AXIOM se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "AXIOM no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar AXIOM",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de AXIOM finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en AXIOM.",
  ...
  "provider.connect.opencodeZen.line1":
    "AXIOM Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en AXIOM.",
  ...
  "dialog.server.description": "Cambiar el servidor de AXIOM al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando AXIOM en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando AXIOM en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza AXIOM en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala AXIOM en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que AXIOM pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "AXIOM no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir AXIOM.",
  ...
  "help.tabs.introduction": "AXIOM Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de AXIOM ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de AXIOM",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: AXIOM aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor AXIOM dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para AXIOM",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve AXIOM en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si AXIOM sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de AXIOM.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia AXIOM",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de AXIOM.",
