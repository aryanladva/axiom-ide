export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do AXIOM",
  ...
  "desktop.menu.ariaLabel": "Menu do AXIOM",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o AXIOM",
  "desktop.recovery.terminated": "A janela do AXIOM foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O AXIOM não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do AXIOM",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O AXIOM não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do AXIOM foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no AXIOM.",
  ...
  "provider.connect.opencodeZen.line1":
    "AXIOM Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no AXIOM.",
  ...
  "dialog.server.description": "Trocar para qual servidor AXIOM este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o AXIOM em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o AXIOM em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o AXIOM em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o AXIOM",
  "wsl.onboarding.opencodeReadyIn": "O AXIOM está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O AXIOM está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o AXIOM em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o AXIOM possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O AXIOM não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o AXIOM novamente.",
  ...
  "help.tabs.introduction": "Agora, o AXIOM Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do AXIOM ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do AXIOM",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: AXIOM ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor AXIOM dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do AXIOM",
  ...
  "settings.general.row.appearance.description": "Personalize como o AXIOM aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o AXIOM segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o AXIOM é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o AXIOM iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do AXIOM.",
