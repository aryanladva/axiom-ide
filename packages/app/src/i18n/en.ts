...
export const dict = {
  ...
  "dialog.provider.opencode.tagline": "Curated, tested models with a single API",
  "dialog.provider.opencode.note": "Curated, tested models with a single API",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in AXIOM.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in AXIOM.",
  ...
  "dialog.server.description": "Switch which AXIOM server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Checking AXIOM in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Updating AXIOM in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update AXIOM in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM is ready.",
  "wsl.onboarding.installOpencodeIn": "Install AXIOM in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before AXIOM can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "AXIOM could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen AXIOM.",
  ...
  "help.tabs.introduction": "AXIOM Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of AXIOM ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the AXIOM team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, AXIOM does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the AXIOM server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for AXIOM",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how AXIOM looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether AXIOM follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how AXIOM is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when AXIOM launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of AXIOM.",
