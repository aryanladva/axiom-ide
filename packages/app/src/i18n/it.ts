export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in AXIOM.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in AXIOM.",
  ...
  "dialog.server.description": "Cambia il server AXIOM a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo AXIOM in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento AXIOM in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna AXIOM in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa AXIOM in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che AXIOM possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "AXIOM non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri AXIOM.",
  ...
  "help.tabs.introduction": "AXIOM Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di AXIOM ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team AXIOM",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: AXIOM non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server AXIOM all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per AXIOM",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di AXIOM sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se AXIOM segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di AXIOM.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di AXIOM",
  ...
  "settings.updates.toast.latest.title": "AXIOM è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di AXIOM.",
  ...
  "desktop.menu.documentation": "Documentazione di AXIOM",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare AXIOM",
  "desktop.recovery.terminated": "La finestra di AXIOM si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "AXIOM non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di AXIOM non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di AXIOM è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
