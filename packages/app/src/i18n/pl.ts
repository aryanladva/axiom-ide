export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja AXIOM",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać AXIOM",
  "desktop.recovery.terminated": "Okno AXIOM zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "AXIOM nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować AXIOM",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja AXIOM została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez AXIOM",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w AXIOM.",
  ...
  "provider.connect.opencodeZen.line1":
    "AXIOM Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w AXIOM.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w AXIOM.",
  ...
  "dialog.server.description": "Przełącz serwer AXIOM, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie AXIOM...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie AXIOM w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie AXIOM...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie AXIOM w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj AXIOM w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj AXIOM",
  "wsl.onboarding.opencodeReadyIn": "AXIOM jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "AXIOM jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj AXIOM w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj AXIOM",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim AXIOM będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "AXIOM nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz AXIOM.",
  ...
  "help.tabs.introduction": "AXIOM Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja AXIOM ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu AXIOM",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: AXIOM nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "AXIOM zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer AXIOM wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla AXIOM",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd AXIOM na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy AXIOM ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw AXIOM.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania AXIOM",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji AXIOM.",
