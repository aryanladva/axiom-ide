...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "AXIOM yüklenemedi",
  "desktop.recovery.terminated": "AXIOM penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "AXIOM yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "AXIOM kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "AXIOM, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "AXIOM güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "AXIOM tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve AXIOM'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak AXIOM'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak AXIOM'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi AXIOM sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "AXIOM kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde AXIOM kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "AXIOM güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde AXIOM güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki AXIOM'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "AXIOM'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde AXIOM hazır.",
  "wsl.onboarding.opencodeReady": "AXIOM hazır.",
  "wsl.onboarding.installOpencodeIn": "AXIOM'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "AXIOM'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "AXIOM kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AXIOM'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "AXIOM bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından AXIOM'u tekrar açın.",
  ...
  "help.tabs.introduction": "AXIOM Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AXIOM'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı AXIOM ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: AXIOM henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "AXIOM ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "AXIOM Masaüstü",
  ...
  "settings.desktop.wsl.description": "AXIOM sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "AXIOM'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "AXIOM'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "AXIOM'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "AXIOM'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "AXIOM başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "AXIOM'un en son sürümünü kullanıyorsunuz.",
