...
const getCurrentUrl = () => {
  ...
  if (import.meta.env.DEV)
    return `http://${import.meta.env.VITE_AXIOM_SERVER_HOST ?? import.meta.env.VITE_OPENCODE_SERVER_HOST ?? "localhost"}:${import.meta.env.VITE_AXIOM_SERVER_PORT ?? import.meta.env.VITE_OPENCODE_SERVER_PORT ?? "4096"}`
