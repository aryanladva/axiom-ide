...
import type { Config, OpencodeClient, Project } from "@axiom-ai/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@axiom-ai/client/promise"
import type { NormalizedProviderListResponse } from "@axiom-ai/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
