...
import { createSimpleContext } from "@axiom-ai/ui/context"
import { pluralCategory, type UiI18nPluralKey } from "@axiom-ai/ui/context/i18n"
import { Persist, persisted } from "@/utils/persist"
import { dict as en } from "@/i18n/en"
import { dict as uiEn } from "@axiom-ai/ui/i18n/en"
import {
...
const loaders: Record<Exclude<Locale, "en">, () => Promise<Dictionary>> = {
  zh: () => merge(import("@/i18n/zh"), import("@axiom-ai/ui/i18n/zh")),
  zht: () => merge(import("@/i18n/zht"), import("@axiom-ai/ui/i18n/zht")),
  ko: () => merge(import("@/i18n/ko"), import("@axiom-ai/ui/i18n/ko")),
  de: () => merge(import("@/i18n/de"), import("@axiom-ai/ui/i18n/de")),
  es: () => merge(import("@/i18n/es"), import("@axiom-ai/ui/i18n/es")),
  fr: () => merge(import("@/i18n/fr"), import("@axiom-ai/ui/i18n/fr")),
  da: () => merge(import("@/i18n/da"), import("@axiom-ai/ui/i18n/da")),
  ja: () => merge(import("@/i18n/ja"), import("@axiom-ai/ui/i18n/ja")),
  pl: () => merge(import("@/i18n/pl"), import("@axiom-ai/ui/i18n/pl")),
  ru: () => merge(import("@/i18n/ru"), import("@axiom-ai/ui/i18n/ru")),
  uk: () => merge(import("@/i18n/uk"), import("@axiom-ai/ui/i18n/uk")),
  ar: () => merge(import("@/i18n/ar"), import("@axiom-ai/ui/i18n/ar")),
  no: () => merge(import("@/i18n/no"), import("@axiom-ai/ui/i18n/no")),
  br: () => merge(import("@/i18n/br"), import("@axiom-ai/ui/i18n/br")),
  th: () => merge(import("@/i18n/th"), import("@axiom-ai/ui/i18n/th")),
  bs: () => merge(import("@/i18n/bs"), import("@axiom-ai/ui/i18n/bs")),
  tr: () => merge(import("@/i18n/tr"), import("@axiom-ai/ui/i18n/tr")),
  hi: () => merge(import("@/i18n/hi"), import("@axiom-ai/ui/i18n/hi")),
  nl: () => merge(import("@/i18n/nl"), import("@axiom-ai/ui/i18n/nl")),
  id: () => merge(import("@/i18n/id"), import("@axiom-ai/ui/i18n/id")),
  vi: () => merge(import("@/i18n/vi"), import("@axiom-ai/ui/i18n/vi")),
  it: () => merge(import("@/i18n/it"), import("@axiom-ai/ui/i18n/it")),
  ur: () => merge(import("@/i18n/ur"), import("@axiom-ai/ui/i18n/ur")),
  pa: () => merge(import("@/i18n/pa"), import("@axiom-ai/ui/i18n/pa")),
  az: () => merge(import("@/i18n/az"), import("@axiom-ai/ui/i18n/az")),
  fi: () => merge(import("@/i18n/fi"), import("@axiom-ai/ui/i18n/fi")),
  sv: () => merge(import("@/i18n/sv"), import("@axiom-ai/ui/i18n/sv")),
}
